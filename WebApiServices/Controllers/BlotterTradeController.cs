...
namespace WebApiServices.Controllers
{
    public class BlotterTradeController : ApiController
    {
        ...
        [HttpGet]
        public JsonResult<List<Models.SP_GetAll_SBPBlotterTrade_Result>> GetAllBlotterTradeDashboard(int UserID, int BranchID, int CurID, int BR, string DateVal)
        {
            EntityMapperBlotterTrade<DataAccessLayer.SP_GetAll_SBPBlotterTrade_Dashboard_Result, Models.SP_GetAll_SBPBlotterTrade_Result> mapObj = new EntityMapperBlotterTrade<DataAccessLayer.SP_GetAll_SBPBlotterTrade_Dashboard_Result, Models.SP_GetAll_SBPBlotterTrade_Result>();
